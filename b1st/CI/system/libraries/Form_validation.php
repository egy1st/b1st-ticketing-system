...
class CI_Form_validation {
	...
	{
		return ( ! preg_match("/^([a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,}$/ix", $str)) ? FALSE : TRUE;
	}
	...
	public function encode_php_tags($str)
	{
	 ...
	 /**
        * By Riaz color Hex test
        *
        * @access        public
        * @param        string
        * @return        string
        */
	public function color_check($str)
	{
		return (bool) preg_match('/#(?:[0-9a-fA-F]{6})\b/',$str);
	}
	/**
     * Validate URL format
     *
