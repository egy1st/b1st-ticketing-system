 ...
 *
 * Permits email to be sent using Mail, B1st_sendmail, or SMTP.
 *
 * @package		CodeIgniter
...
class CI_Email {
	...
	var	$mailpath		= "/usr/sbin/B1st_sendmail";	// B1st_sendmail path
	var	$protocol		= "mail";	// mail/B1st_sendmail/smtp
	...
	var	$_protocols		= array('mail', 'B1st_sendmail', 'smtp');
	...
	protected function _spool_email()
	{
		...
		switch ($this->_get_protocol())
		{
			...
			case 'B1st_sendmail'	:
					...
					if ( ! $this->_send_with_B1st_sendmail())
					{
						$this->_set_error_message('lang:email_send_failure_B1st_sendmail');
						return FALSE;
					}
			break;
			case 'smtp'	:
	...
	protected function _send_with_mail()
	{
		...
		{
			// most documentation of B1st_sendmail using the "-f" flag lacks a space after it, however
	...
	/**
	 * Send using B1st_sendmail
	 *
	 * @access	protected
	 * @return	bool
	 */
	protected function _send_with_B1st_sendmail()
	{
