       ...
       <!--another_extra_area-->
         ...
         <div class="product_box" id="side_area">
          <div class="headding_bl">
           <p><span><i class="fa fa-th-list"></i></span><?php echo $this->lang->line('Add Knowledge Base');?></p>
          </div>
	  
	  <form action="<?= TICKET_PLUGIN_URL;?>CI/index.php/knowledgebase/insert" method="post">
		...
		<div class="form_holder">
		   ...
		   if(!empty($catdet))
		   {
		    ...
		    {
		      ?>
		      <option <?php if(set_value('category_id')==$catdetlist->id) { ?> selected="true" <?php } ?> value="<?php echo $catdetlist->id;?>"><?php echo $catdetlist->category_name;?></option>
		      <?php
		    }
		   }
		   ?>
		   ...
		   if(!empty($productdet))
		   {
		    ...
		    {
		      ?>
		      <option <?php if(set_value('product_id')==$productdetlist->id) { ?> selected="true" <?php } ?> value="<?php echo $productdetlist->id;?>"><?php echo $productdetlist->product_name;?></option>
		      <?php
		    }
		   }
		   ?>
		...
		<div class="form_holder">
		  ...
		  <input type="text" name="topic" placeholder="<?php echo $this->lang->line('Enter');?> <?php echo $this->lang->line('Topic');?>" value="<?php echo set_value('topic');?>">
		</div>
	       
               
               <div class="form_holder">
                 <label><span><?php echo $this->lang->line('Content');?></span></label><br />
                 <textarea name="content" cols="" rows=""><?php echo set_value('content');?></textarea>
               </div>
