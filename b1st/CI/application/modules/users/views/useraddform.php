<?php $this->load->view('common/header'); ?>
       ...
       <!--another_extra_area-->
         ...
         <div class="product_box" id="side_area">
          <div class="headding_bl">
           <p><span><i class="fa fa-th-list"></i></span><?php echo $this->lang->line('Add User');?></p>
          </div>
    
    <form action="<?= TICKET_PLUGIN_URL;?>CI/index.php/users/insert" method="post">
    ...
    <div class="form_holder">
      ...
      <input type="text" name="username" placeholder="<?php echo $this->lang->line('Enter Username');?>" value="<?= set_value('username'); ?>" onblur="checkusername(this.value,this)">
    </div>
    
    <div class="form_holder">
      <label><span><?php echo $this->lang->line('First Name');?></span></label>
      <input type="text" name="firstname" placeholder="<?php echo $this->lang->line('Enter First Name');?>" value="<?= set_value('firstname'); ?>">
    </div>

    <div class="form_holder">
      <label><span><?php echo $this->lang->line('Last Name');?></span></label>
      <input type="text" name="lastname" placeholder="<?php echo $this->lang->line('Enter Last Name');?>" value="<?= set_value('lastname'); ?>" >
    </div>
    
    <div class="form_holder">
      <label><span><?php echo $this->lang->line('Email');?></span></label>
      <input type="text" name="email" placeholder="<?php echo $this->lang->line('Enter Email');?>" value="<?= set_value('email'); ?>">
    </div>
    ...
    <div class="form_holder">
      ...
      <!--</select>-->
      <!--</div>-->
      <input style="" type="text" name="mobile" placeholder="<?php echo $this->lang->line('Enter Mobile');?>" value="<?= set_value('mobile'); ?>">
    </div>
    ...
    <div class="form_holder">
      ...
      <input type="password" name="cpassword" placeholder="" onblur="confirmPassword(this,$('#password'))">
    </div>
               </div>
         ...
         <div class="form_holder">
                 ...
                 <select name="privilege_group_id">
                  ...
                  if(!empty($privilegegroups))
                  {
                    ...
                    {
                      ?>
                      <option value="<?php echo $privilegegroup->id;?>" <?= set_select('privilege_group_id',$privilegegroup->id) ?> ><?php echo stripslashes($privilegegroup->privilege_name);?></option>
                      <?php
                    }
                  }
                  ?>
