       ...
       <!--another_extra_area-->
         ...
         <div class="product_box" id="side_area">
          <div class="headding_bl">
           <p><span><i class="fa fa-th-list"></i></span><?php echo $this->lang->line('Edit Theme');?></p>
          </div>
	  
	  <form action="<?= TICKET_PLUGIN_URL;?>CI/index.php/theme/update" method="post" id="themeedit">
		...
		<div class="form_holder">
		  ...
		  <input type="text" name="theme_name" placeholder="<?php echo $this->lang->line('Enter');?> <?php echo $this->lang->line('Theme Name');?>" value="<?=$det->theme_name;?>">
		  <input type="hidden" name="old_theme_name" placeholder="<?php echo $this->lang->line('Enter');?> <?php echo $this->lang->line('Theme Name');?>" value="<?=$det->theme_name;?>">
		</div>
    <div class="form_holder">
      <label><span><?php echo $this->lang->line('Theme Color');?></span></label>
      <input type="text" name="theme_color" id="theme_color" value="<?=$det->theme_color;?>" maxlength="7" style="width: 60px">
      <input type="hidden" name="old_theme_color" value="<?=$det->theme_color;?>" maxlength="7" style="width: 60px">
    </div>
    <script type="text/javascript">
      var options = {
		...
		<input type="hidden" readonly="true" name="chkval" id="chkval" value="0" />
               <button class="sbmt sbmt_base sbmt_base-no-border" type="button" onclick="checksubmit()"><i class="fa fa-spinner upload_icon"></i><?php echo $this->lang->line('Update');?></button>
               </div>
