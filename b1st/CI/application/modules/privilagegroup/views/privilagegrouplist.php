     ...
     <tbody>		   
		  ...
		  if(!empty($companydet))
		  {
           ...
           <?php if($companydetlist->id != 1){ ?>	
				     <button type="submit" class="edit_button bitn nuc_bl has-tip" title="<?php echo $this->lang->line('Edit');?>" onclick="window.location.href='<?= TICKET_PLUGIN_URL;?>CI/index.php/privilagegroup/edit/<?php echo $companydetlist->id;?>'"><i class="fa fa-pencil"></i></button>
