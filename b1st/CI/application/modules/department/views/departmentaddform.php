       ...
       <!--another_extra_area-->
         ...
         <div class="product_box" id="side_area">
          <div class="headding_bl">
           <p><span><i class="fa fa-th-list"></i></span><?php echo $this->lang->line('Add Department');?></p>
          </div>
	  
	  <form action="<?= TICKET_PLUGIN_URL;?>CI/index.php/department/insert" method="post">
		...
		<div class="form_holder">
		  ...
		  <input type="text" name="department_name" placeholder="<?php echo $this->lang->line('Enter');?> <?php echo $this->lang->line('Department Name');?>" value="<?php echo set_value('department_name');?>">
		</div>
