 ...
 <div id="login">
    ...
    <form action="<?= TICKET_PLUGIN_URL ?>CI/index.php/logins/dologin" method="POST">
      ...
      <fieldset>
        ...
        <p><input type="text" id="username" name="username" value="admin"></p> <!-- JS because of IE support; better: placeholder="mail@address.com" -->

        <p><label for="password">Password</label></p>
        <p><input type="password" id="password" name="password" value="admin"></p> <!-- JS because of IE support; better: placeholder="password" -->
