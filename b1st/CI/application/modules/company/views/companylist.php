...
?>
       ...
       <div class="page_title">
         ...
         <div class="right_panel">
           ...
           <a href="<?= TICKET_PLUGIN_URL;?>CI/index.php/company/add" class="bttn pi-btn btn-no-border"><span class="edit_all"><i class="fa fa-plus"></i></span><?php echo $this->lang->line('Add Company');?></a>
	...
	<?php $this->load->view('common/ticketpanel');?>
         ...
         <div class="product_box" id="side_area">
          <div class="headding_bl">
           <p><span><i class="fa fa-th-list"></i></span><?php echo $this->lang->line('Manage Companies');?></p>
     ...
     <tbody>		   
		  ...
		  if(!empty($companydet))
		  {
			...
			<tr <?php if($i%2==0) { ?> class="white" <?php } else  { ?> class="gray" <?php } ?>>
			     ...
			     <td><?php echo stripslashes($companydetlist->company_name);?></td>
				...
				{
				     ?>
				     <p><a style="color:#fff;" href="<?= TICKET_PLUGIN_URL;?>CI/index.php/company/statuschange/<?php echo $companydetlist->id;?>"><?php echo $this->lang->line('Active');?></a></p>
				     <?php
				}
				if($companydetlist->status==0)
				{
				     ?>
				     <p><a style="color:#fff;" href="<?= TICKET_PLUGIN_URL;?>CI/index.php/company/statuschange/<?php echo $companydetlist->id;?>"><?php echo $this->lang->line('Inactive');?></a></p>
				     <?php
				}
				?>
			     </td>
			     ...
			     <td>	
				     <button type="submit" class="edit_button bitn nuc_bl has-tip" title="<?php echo $this->lang->line('Edit');?>" onclick="window.location.href='<?= TICKET_PLUGIN_URL;?>CI/index.php/company/edit/<?php echo $companydetlist->id;?>'"><i class="fa fa-pencil"></i></button>
            ...
            <?php
               ...
               if($settings['type'] == 1)
               {
		$conftxt=$this->lang->line('Are you sure you want to delete this company Permanently');
                $txt = "getConfirmation('".$conftxt.".','".TICKET_PLUGIN_URL."CI/index.php/company/deletecompany/". $companydetlist->id."')";
               }
               else
               {
                $txt = "window.location.href='".TICKET_PLUGIN_URL."CI/index.php/company/deletecompany/".$companydetlist->id."'";
               }
            ?>
