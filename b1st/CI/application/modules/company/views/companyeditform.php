	 ...
	 <?php
       ...
       <!--another_extra_area-->
         ...
         <div class="product_box" id="side_area">
          <div class="headding_bl">
           <p><span><i class="fa fa-th-list"></i></span><?php echo $this->lang->line('Edit Company');?></p>
          </div>
	  ...
	  <form action="<?= TICKET_PLUGIN_URL;?>CI/index.php/company/update" method="post">
		...
		<div class="form_holder">
		  ...
		  <input type="text" name="company_name" placeholder="<?php echo $this->lang->line('Enter');?> <?php echo $this->lang->line('Company Name');?>" value="<?=$det->company_name;?>">
		  <input type="hidden" name="old_company_name" placeholder="<?php echo $this->lang->line('Enter');?> <?php echo $this->lang->line('Company Name');?>" value="<?=$det->company_name;?>">
		</div>
