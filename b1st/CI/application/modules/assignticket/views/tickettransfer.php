	...
	<?php $this->load->view('common/ticketpanel');?>
         ...
         <div class="product_box" id="side_area">
          <div class="headding_bl">
           <p><span><i class="fa fa-th-list"></i></span><?php echo $this->lang->line('Transfer Tickets');?>
            <form id="pageNo" action="<?= TICKET_PLUGIN_URL;?>CI/index.php/assignticket/transferTicket/<?= $this->uri->segment(3) ?>" method="post">
         ...
         <div class="child_cake">
            <div class="drop_down_pi">
             <div class="all_dro">
             <strong><?php echo $this->lang->line('Transfer Multiple Tickets To');?> :</strong>
<form action="<?= TICKET_PLUGIN_URL;?>CI/index.php/assignticket/multitickettransfer" method="post">
     ...
     <tr>
        ...
        <?php } ?>
		  ...
		  if(!empty($ticketdet))
		  {
			...
			{
			  $check = B1st_checkTicketAssignment($ticketdetlist->id);
			 if(!$check)
			 {
			    continue;
			 }
			 $jarr[]=$ticketdetlist->id;
			?>
			<tr <?php if($i%2==0) { ?> class="white" <?php } else  { ?> class="gray" <?php } ?>>
              ...
              <td><?php
               ...
               ?></td>
			     <td>	
				     <form action="<?= TICKET_PLUGIN_URL;?>CI/index.php/assignticket/tickettransfer" method="post">
