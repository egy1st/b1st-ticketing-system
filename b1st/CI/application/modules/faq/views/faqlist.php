		  ...
		  if(!empty($faqdet))
		  {
			...
			<tr <?php if($i%2==0) { ?> class="white" <?php } else  { ?> class="gray" <?php } ?>>
				...
				?>
			     ...
			     <td>	
				     <button type="submit" class="edit_button bitn nuc_bl has-tip" title="<?php echo $this->lang->line('Edit');?>" onclick="window.location.href='<?= TICKET_PLUGIN_URL;?>CI/index.php/faq/edit/<?php echo $faqdetlist->id;?>'"><i class="fa fa-pencil"></i></button>
