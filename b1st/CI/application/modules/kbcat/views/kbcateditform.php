       ...
       <!--another_extra_area-->
         ...
         <div class="product_box" id="side_area">
          <div class="headding_bl">
           <p><span><i class="fa fa-th-list"></i></span><?php echo $this->lang->line('Edit Knowledge Base Category');?></p>
          </div>
	  
	  <form action="<?= TICKET_PLUGIN_URL;?>CI/index.php/kbcat/update" method="post">
		...
		<div class="form_holder">
		  ...
		  <input type="text" name="category_name" placeholder="<?php echo $this->lang->line('Enter');?> <?php echo $this->lang->line('Knowledge Base Category Name');?>" value="<?=$det->category_name;?>">
		  <input type="hidden" name="old_category_name" placeholder="<?php echo $this->lang->line('Enter');?> <?php echo $this->lang->line('Knowledge Base Category Name');?>" value="<?=$det->category_name;?>">
		</div>
