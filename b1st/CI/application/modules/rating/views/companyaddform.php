       ...
       <!--another_extra_area-->
         ...
         <div class="product_box" id="side_area">
          <div class="headding_bl">
           <p><span><i class="fa fa-th-list"></i></span>Add Company</p>
          </div>
	  ...
	  <form action="<?= TICKET_PLUGIN_URL;?>CI/index.php/company/insert" method="post">
		...
		<div class="form_holder">
		  ...
		  <input type="text" name="company_name" placeholder="Enter Company Name">
               ...
               <div class="form_holder">
               <button class="sbmt sbmt_base sbmt_base-no-border" type="submit"><i class="fa fa-spinner upload_icon"></i>Add</button>
               </div>
